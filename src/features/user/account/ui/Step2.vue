...
const isValid = computed(() => time.value !== 0 && authCode.value.length === 4);
  ...
  <div class="flex flex-col h-full">
    ...
    <div class="flex flex-col flex-1 justify-between">
      ...
      <div class="flex flex-col gap-1 w-full items-center">
        ...
        >
        <LgMainButton :disabled="!isValid" @click="() => (isModalOpen = true)"
          >완료</LgMainButton
        >
      </div>
    </div>
